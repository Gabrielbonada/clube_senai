...
<main>
    ...
    <p class="testimonial-text">
        "Explicação incrível! Consegui aplicar tudo na minha arte no mesmo dia."
    </p>
    <div class="testimonial-author">
        <img src="https://i.pravatar.cc/100?img=12" alt="">
        <div>
            <strong>Bernardo Lima</strong>
            <span>Designer</span>
        </div>
    </div>
</div>
...
<div class="testimonial-card">
    ...
    <p class="testimonial-text">
        "Muito claro e direto, adorei a parte sobre contraste."
    </p>
    <div class="testimonial-author">
...
<div class="testimonial-card">
    ...
    <p class="testimonial-text">
        "Já quero mais conteúdos assim no blog!"
    </p>
    <div class="testimonial-author">
        <img src="https://i.pravatar.cc/100?img=33" alt="">
        <div>
            <strong>Carlos Duarte</strong>
            <span>Leitor</span>
        </div>
    </div>
</div>
...
<div class="testimonial-card">
    ...
    <p class="testimonial-text">
        "Esse blog está ficando cada vez mais profissional."
    </p>
    <div class="testimonial-author">
...
<div class="testimonial-card">
    ...
    <p class="testimonial-text">
        "Adorei a identidade visual do site também."
    </p>
    <div class="testimonial-author">
        <img src="https://i.pravatar.cc/100?img=55" alt="">
        <div>
            <strong>Luan Mendes</strong>
...
<div class="testimonial-card">
    ...
    <p class="testimonial-text">
        "Simplesmente perfeito! Continue postando."
    </p>
    <div class="testimonial-author">
        <img src="https://i.pravatar.cc/100?img=66" alt="">
        <div>
            <strong>Irael Rocha</strong>
            <span>Estudante</span>
        </div>
    </div>
</div>
...
<div class="testimonial-card">
    ...
    <p class="testimonial-text">
        "Esse tipo de conteúdo é ouro para quem está começando."
    </p>
    <div class="testimonial-author">
        <img src="https://i.pravatar.cc/100?img=15" alt="">
        <div>
            <strong>Letícia Ramos</strong>
            <span>Iniciante em Ilustração</span>
        </div>
    </div>
</div>
    </section>
